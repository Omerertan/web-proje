          ...
          <h3 style="text-align: center;">Admin</h3>
            ...
            {{ csrf_field() }}
              <div class="form-group">
                ...
                <input type="email" class="form-control " name="email" value="{{Cookie::get('email')}}" id="exampleInputEmail1" aria-describedby="emailHelp" >             
              </div>
              <div class="form-group">
                <label for="exampleInputPassword1" name="password">Şifre</label>
                <input type="password" class="form-control " value="{{Cookie::get('password')}}" name="password" id="exampleInputPassword1" >
              </div>
              <div class="form-group form-check">
                <input type="checkbox" class="form-check-input" {{ Cookie::get('remember') ? 'checked' : '' }} id="exampleCheck1" name="rememberme">
              ...
              <div style="margin-top: 10px;">                
                <a href="{{ route('home')}}" style="float: left;"> Siteye Dön</a>
              </div>            
            </form>
          </div>
      </div>
